<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/css/bootstrap.css/bootstrap-theme.min.css" >
              ...
              <div class="form-group">
                <div class="col-md-12 control">
                  <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
                    No tiene una cuenta! <a href="<?php echo base_url();?>registro/registrar_usuario">Registrate aquí</a>
                  </div>
                </div>
              </div>    
            </form>
