    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url();?>assets/img/su.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <li class=""><a href="<?php echo base_url();?>registro/inicio"><i class="fa fa-home"></i> <span>Inicio</span></a></li>
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>cita_controller/ver_cita_root"><i class="glyphicon glyphicon-user"></i>Citas Agendadas</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>consulta_controller/consulta_root"><i class="glyphicon glyphicon-user"></i>Mostrar Consultas Registradas</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>paciente_controller/ver_paciente_root"><i class="glyphicon glyphicon-barcode"></i> <span>Registro de Pacientes</span></a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>expediente_controller/ver_expediente_root"><i class="glyphicon glyphicon-barcode"></i> <span>Expedientes Registrados</span></a></li>
