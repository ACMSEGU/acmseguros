              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=$a->user?></td>
                   ...
                   <td><a href="<?php echo base_url();?>Registro/accion?id=<?=$a->id?>" class="btn btn-success fa fa-edit"></td>
                    <?php 
                    if ($this->session->userdata('user') != $a->user) { 
                      echo '<td><button class="btn btn-danger fa fa-trash" onclick="Eliminar('.$a->id.')"></button></td>';
                    }
                    else{
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>UML &copy; 2021<a href="#"></a>.</strong> All rights reserved.
  </footer>  
</div>
<!-- REQUIRED JS SCRIPTS -->
...
function Eliminar(id){
  ...
  if(opcion == true){
    window.location='<?php echo base_url();?>registro/eliminar?id='+id;
  }
}
// -->
</script>
